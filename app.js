...
const hpPokemon = pokemon.find(p => p.hp == "105");
...
function sortHp(hp1, hp2) {
    if(hp1.hp > hp2.hp){
        return -1;
    } else return 1;
}

game.party.sort(sortHp);
...
let evolvedPokemon = pokemon[25];

for (let i = 0; i < game.party.length; i++) {
    if (game.party[i] === electricPokemon) {
...
// const starterPikachu = pokemon.find(p => p.name === "Pikachu");
// let innerArrayIndex = 3;
// let elementIndex = 1;

// function innerArray(){

// if(starterPikachu) {
//     game.party[innerArray].splice(elementIndex, 1, "name: 'Raichu'");
// }
// }
// console.log(starterPikachu);



// let idx = [i, j];

// function findPikachuIndex(idx) {
//     for (let i = 0; i < game.party.length; i++) {
//         for (let j = 0; j < game.party[i].length; j++) {
//             if (game.party[i][j] === idx) {
//                 return [i, j];
//         }
//         }
//     }
// }
// console.log(findPikachuIndex(idx));
...
*/
let pokemonObj = pokemon[13];

game.catchPokemon = (pokemonObj); {
    game.party.push(game.catchPokemon);
}
...
game.catchPokemon = (pokemonObj); {
    game.party.push(game.catchPokemon);
    if(game.catchPokemon = true && game.items.some(item => item.name === 'pokeball' && item.quantity > 0)){
        game.items.find(item => item.name ==='pokeball').quantity--;
    }
}

console.log(game.catchPokemon[15]);
